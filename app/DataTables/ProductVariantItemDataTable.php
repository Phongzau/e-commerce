    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $editBtn = "<a class='btn btn-primary' href='" . route('admin.product-variant-item.edit', $query->id) . "'><i class='far fa-edit'></i></a>";
                $deleteBtn = "<a class='btn btn-danger ml-2 delete-item' href='" . route('admin.product-variant-item.destroy', $query->id) . "'><i class='far fa-trash-alt'></i></a>";
