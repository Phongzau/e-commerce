        <div class="dashboard_sidebar">
            ...
            <ul class="dashboard_link">
                <li><a class="{{ setActive(['vendor.dashboard']) ? 'active' : '' }}"
                        href="{{ route('vendor.dashboard') }}"><i class="fas fa-tachometer"></i>Dashboard</a>
                </li>

                <li><a class="{{ setActive(['vendor.orders']) ? 'active' : '' }}" href="{{ route('vendor.orders') }}"><i
                            class="far fa-user"></i> Orders</a>
                </li>
