    ...
    <div class="card">
        <div class="card-body border">
            <form action="{{ route('admin.homepage-banner-section-two') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <img width="150px" src="{{ asset(@$homepage_section_banner_two->banner_one->banner_image) }}"
                        alt="">
                </div>
                ...
                <div class="form-group">
                    <img width="150px" src="{{ asset(@$homepage_section_banner_two->banner_two->banner_image) }}"
                        alt="">
                </div>
