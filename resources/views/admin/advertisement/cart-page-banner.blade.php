<div class="tab-pane fade" id="list-cart" role="tabpanel" aria-labelledby="list-home-list">
    <div class="card">
            ...
            <form action="{{ route('admin.cartpage-banner') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="banner_one_url"
                        value="{{ @$cart_page_banner_section->banner_one->banner_url }}" class="form-control">
                </div>
                <hr>
                <h5>Banner Two</h5>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="banner_two_url"
                        value="{{ @$cart_page_banner_section->banner_two->banner_url }}" class="form-control">
                </div>
